...
export const ICONS = {
    ...
    bold: <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2"><path strokeLinecap="round" strokeLinejoin="round" d="M6 4h8a4 4 0 014 4 4 4 0 01-4 4H6z" /><path strokeLinecap="round" strokeLinejoin="round" d="M6 12h9a4 4 0 014 4 4 4 0 01-4 4H6z" /></svg>,
    italic: <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2"><path strokeLinecap="round" strokeLinejoin="round" d="M11 4h6" /><path strokeLinecap="round" strokeLinejoin="round" d="M7 20h6" /><path strokeLinecap="round" strokeLinejoin="round" d="M14 4L10 20" /></svg>,
    strikethrough: <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2"><path strokeLinecap="round" strokeLinejoin="round" d="M12 5c-2.5 0-4.5 1.5-4.5 3.5s2 3.5 4.5 3.5 4.5 1.5 4.5 3.5-2 3.5-4.5 3.5 M4 12h16" /></svg>,
    textColor: <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}><path strokeLinecap="round" strokeLinejoin="round" d="M4 20h16" /><path strokeLinecap="round" strokeLinejoin="round" d="M12 4L7.5 16h9L12 4z" /><path strokeLinecap="round" strokeLinejoin="round" d="M9.5 12.5h5" /></svg>,
